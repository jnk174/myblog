                        ...
                        <div className="flex items-center gap-2">
                          {(() => {
                            const categoryBadgeColors: Record<string, string> = {
                              ...
                              자동화: "border-rose-200 bg-rose-100 text-rose-800 dark:border-rose-800/60 dark:bg-rose-950/60 dark:text-rose-200",
                            ...
                            return (
                              <span className={`inline-flex rounded-md border px-2.5 py-1 text-[10px] font-black uppercase tracking-widest ${color}`}>
                                {post.category}
                              </span>
                            );
                          })()}
