    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <section className="mt-16 bg-secondary/50 rounded-3xl p-8 border-2 border-dashed border-primary/10">
        ...
        <ul className="space-y-4 text-sm text-muted-foreground font-medium">
          ...
          <li className="flex gap-3">
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary/20 text-[10px] font-black text-primary">3</span>
            보안상 이 페이지(/admin/stats)는 이 브라우저에서만 접속 가능합니다. 만약 다른 기기에서 접속하려면 URL 뒤에 <code>?admin_secret=ska48*!qmf</code>를 붙여 한 번 방문해야 합니다.
          </li>
        </ul>
      </section>
    </div>
